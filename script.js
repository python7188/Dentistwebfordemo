...
/* ============================================================
   WOW FACTOR INTERACTIONS (GSAP, Lenis, Custom Cursor)
   ============================================================ */

function initWowFactor() {
...
document.addEventListener('DOMContentLoaded', initWowFactor);



  // 5. AI Smile Simulator Logic
  const aiBtn = document.getElementById('trigger-ai-btn');
  if (aiBtn && typeof gsap !== 'undefined') {
